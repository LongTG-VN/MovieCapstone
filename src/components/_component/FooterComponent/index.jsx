      ...
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div className="text-white">
            <h2 className="mb-6 text-white text-sm font-semibold text-warning-medium uppercase">
              Company
            </h2>
            <ul className="text-body text-amber-50 font-medium">
          ...
          <div>
            <h2 className="mb-6 text-white text-sm font-semibold text-heading uppercase">
              Help center
            </h2>
